...
class CheckCodeByIdScreen extends StatefulWidget {
  const CheckCodeByIdScreen({Key? key}) : super(key: key);

  @override
  State<CheckCodeByIdScreen> createState() => _CheckCodeByIdScreenState();
}

class _CheckCodeByIdScreenState extends State<CheckCodeByIdScreen> {
            ...
            children: [
              ...
              OutlinedButton(
                onPressed: () {
                    ...
                    if (element.controller.text.isEmpty) {
                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(
                          ...
                          content: Text(
                            "Please enter the 4-digit Confirmation code".tr,
                          ),
                        ),
                      );
                      return;
                  ...
                  CheckCodeByIdCtrl.find.fetchCheckCodeData(
                    context,
                    otp:
